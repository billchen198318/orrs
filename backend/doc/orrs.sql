...
INSERT INTO `tb_orrs_command_prompt` VALUES ('81235d41-a295-11ef-9831-d71333d1d941','PP02',0,'echarts 版本請用 5.3.3 , CDN 位置 https://cdnjs.cloudflare.com/ajax/libs/echarts/5.3.3/echarts.min.js','admin','2024-11-14 22:34:07',NULL,NULL),('8123d272-a295-11ef-9831-57fcb2b073ea','PP02',1,'echarts 圖表寬度740px , 高度600px , echarts 圖表請配置 tooltip','admin','2024-11-14 22:34:07',NULL,NULL),('812495c3-a295-11ef-9831-3116f35e2a10','PP02',2,'這很重要必須遵守: json資料筆數不要刪減','admin','2024-11-14 22:34:07',NULL,NULL),('99e3729f-a49f-11ef-8f91-3ba96d7372cb','PP01',0,'json library 使用的是 com.fasterxml.jackson','admin','2024-11-17 12:51:26',NULL,NULL),('99e3e7d0-a49f-11ef-8f91-a7d00ef07513','PP01',1,'回應訊息不需要給 implementation , maven, gradle 資訊','admin','2024-11-17 12:51:26',NULL,NULL),('99e45d01-a49f-11ef-8f91-61adaea67498','PP01',2,'你必須遵守: 不要把結果用 print 或 println 方式輸出, 請用 return 方式輸出值','admin','2024-11-17 12:51:26',NULL,NULL);
...
INSERT INTO `tb_orrs_task` VALUES ('7590bed3-9aab-11ef-b609-854d67a445fb','task02','我的水量拆分檔任務','水量資料','0 52 12 * * ?','Y','admin','2024-11-04 20:51:07','admin','2024-11-17 12:51:52');
...
INSERT INTO `tb_orrs_task_cmd` VALUES ('a9cb8f9a-a49f-11ef-8f91-55f2aafd3d25','task02','PP01',0,'Y','admin','2024-11-17 12:51:52',NULL,NULL),('a9cc04cb-a49f-11ef-8f91-f9de8981b6d0','task02','PP02',1,'Y','admin','2024-11-17 12:51:52',NULL,NULL);
...
-- Dump completed on 2024-11-17 13:02:58
