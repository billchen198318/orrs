...
export default {
	...
	methods: { 
		...
		btnClear : function() {
			...
			this.queryPageStore.queryParam.docId = '';
			this.dsList = [];
...
function _btnQuery() {
	...
	axiosInstance.post(import.meta.env.VITE_API_URL + PageConstants.eventNamespace + '/findPage', {
		"field": {
			"docId"     : this.queryPageStore.queryParam.docId,
...
<div class="row" v-show=" qFieldShow ">
	<div class="col-xs-6 col-md-6 col-lg-6">
		<div class="form-group form-floating">
			<input type="text" class="form-control" id="docId" placeholder="輸入編號" v-model="this.queryPageStore.queryParam.docId">
			<label for="docId">編號</label>
    	</div>
  	</div>
  	<div class="col-xs-6 col-md-6 col-lg-6">
    	<div class="form-group form-floating">
